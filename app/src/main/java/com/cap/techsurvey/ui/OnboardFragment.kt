...
//            Question(id = 1, text = "Primeira pergunta", options = option1, weight = 3),
//            Question(id = 2, text = "Cor preferida", options = option2, weight = 3),
//            Question(id = 3, text = "Nome da mãe", options = option3, weight = 3),
//            Question(id = 4, text = "Faculdade", options = option4, weight = 3)
//        )
//
//        val survey = Survey(
//            id = 4,
